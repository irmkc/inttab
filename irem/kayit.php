...
<body>
    <main>
        ...
        <form method="post" action="kayitkontrol.php">
            ...
            <input type="text" id="soyad" name="soyad" value="<?php if (isset($_SESSION["soyad"])) echo $_SESSION["soyad"]; ?>">
            ...
            <input type="submit" value="Kaydol!" style="color: white; padding: 10px 10px; border: none; border-radius: 100px; cursor: pointer; width: 25%; background-color: var(--color4);">
        </form>
    </main>
</body>
</html>
